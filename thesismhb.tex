...
%% KC important otherwise the babel translation "Table des figures"  will be used
...
\usepackage{xcolor}
 ...
 % all the chapter's header will be in english, even if you
...
\usepackage{bookmark} % Remédie à des petits problème
  ...
  \hypersetup{
    ...
    pdfkeywords = {écologie des communautés, changement climatique, équilibre et dynamique transitoire, forêts, diversité beta, dynamique de transition, migration des arbres, recrutement, Québec, perturbations}
  }
...
\date{15 mai 2020} %Date du DÉPÔT INITIAL (ou du 2e dépôt s'il y a corrections majeures)
