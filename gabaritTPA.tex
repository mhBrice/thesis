...
\title{Réponses spatio-temporelles des communtautés forestières dans l'écotone boréal-tempéré face aux changements climatiques}
...
\begin{twocolumnlist}{.2\textwidth}{.7\textwidth}
  AIC & Critère d'information d'Akaike, de l'anglais
      \textit{Akaikes Information Criteria}\\
  DBH  & Diamètre hauteur poitrine (1.3m), de l'anglais
      \textit{Diameter at breast height} \\
  CTI  &  Indice de température de la communauté, de l'anglais \textit{Community Temperature Index}\\
